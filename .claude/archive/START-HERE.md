...
## 🚨 CRITICAL: Context Management - Use AGENTS for Library Research

**You have ~200k tokens per session. Use them wisely!**

### Library Search Protocol

**❌ NEVER run library searches directly in main conversation**
- Each search burns ~5-10k tokens
- You'll run out of context quickly

**✅ ALWAYS deploy an agent for library research**
```
Task: general-purpose
Search Derek's library for [TOPIC] using scripts at
Saved/Derek/Reference-Library/scripts/search.py
Return synthesized findings with citations.
```

**See:** `.claude/LIBRARY-SEARCH-PROTOCOL.md` for complete instructions
