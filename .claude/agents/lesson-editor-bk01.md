...
**CRITICAL FILE HANDLING:** When you craft Part 3, you MUST **APPEND it to the SAME file** that contains Parts 1-2.5. Do NOT create a new file. Read the existing file, then append Part 3 to the end of that SAME file.
...
**CRITICAL:** After completing Part 3, you MUST append the following metadata sections at the end of every lesson:

### Related Concepts
List connections to previous lessons in the series. Use this format:
...
- Adapt the list based on which lessons exist
- Keep the format consistent: `**Related Concepts**: Lesson Name (Lesson ###), Lesson Name (Lesson ###)`

### Writing Team Attribution
List all team members who contributed to this lesson. Use this exact format:

```
**Writing Team**: IQ2 (Story Architect + Audience Advisor) | Character Weaver (Derek Character Specialist) | Zen Scribe (Voice Execution Specialist) | Lesson Editor (Final Synthesis with Opening Hooks)
```

**Rules:**
- Include all contributors
- Use the pipe separator `|` between team members
- Keep role descriptions concise and consistent

### Process Documentation
Document the workflow used to create this lesson. Use this format:

```
**Process**: Part 1 (Qdrant Research) + Part 2 (Writing Team Dialogue) + Part 2.5 (Integration Round) + Part 3 (Lesson Editor crafts flowing lesson — opens with hook, enhances concepts)
```

**Rules:**
- Brief description of each part's contribution
- Keep to one line
- Highlight key methods (e.g., "opens with hook, enhances concepts")
