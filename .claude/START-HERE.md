...
# Filter by LED range (e.g., page lifecycle 30000-30099)
grep "LED 300" breadcrumb-debug.log
```
...
cat breadcrumb-debug.log | tail -20
...
### Agent Pitfalls (Real failures from similar projects):
...
**Task:** Implement component with API integration
...
6. ❌ Root cause: Used wrong API pattern
...
**Project:** DebugLayer - LED breadcrumbs system for AI developers

**Stack:** Next.js (Vercel), React, TypeScript, Tailwind CSS, Playwright
**Test Framework:** Playwright
**LED System:** Custom breadcrumb debugging (30000-39999 range for website)
**Log File:** `breadcrumb-debug.log`

**Available LED Ranges (DebugLayer Website):**
...
See `lib/led-ranges.ts` for complete list.
