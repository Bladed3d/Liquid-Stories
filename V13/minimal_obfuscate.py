#!/usr/bin/env python3
"""
Minimal HTML Protection for GitHub Pages
Preserves functionality and prevents JavaScript corruption
"""
...
def process_file(input_file, output_file):
    ...
    # Very gentle minification - just remove extra blank lines and basic whitespace
    lines = content.split('\n')
    cleaned_lines = []
    for line in lines:
        stripped = line.strip()
        if stripped:
            ...
            if cleaned_lines and cleaned_lines[-1] not in ['</script>', '</style>', '</head>', '</body>']:
...
def main():
    ...
    print("Starting Minimal HTML Protection for GitHub Pages...")
    ...
    print(f"   • Preserved JavaScript functionality")
